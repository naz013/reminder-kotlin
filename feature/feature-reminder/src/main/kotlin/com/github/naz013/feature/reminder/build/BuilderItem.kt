...
import com.github.naz013.feature.reminder.build.bi.BooleanModifier
import com.github.naz013.feature.reminder.build.bi.BuilderModifier
import com.github.naz013.feature.reminder.build.bi.CalendarDuration
import com.github.naz013.feature.reminder.build.bi.DateModifier
import com.github.naz013.feature.reminder.build.bi.DefaultStringModifier
import com.github.naz013.feature.reminder.build.bi.EmailModifier
import com.github.naz013.feature.reminder.build.bi.FormattedStringModifier
import com.github.naz013.feature.reminder.build.bi.GoogleCalendarDurationModifier
import com.github.naz013.feature.reminder.build.bi.GoogleCalendarModifier
import com.github.naz013.feature.reminder.build.bi.GoogleTaskListModifier
import com.github.naz013.feature.reminder.build.bi.GroupModifier
import com.github.naz013.feature.reminder.build.bi.IntModifier
import com.github.naz013.feature.reminder.build.bi.ListIntModifier
import com.github.naz013.feature.reminder.build.bi.ListLongModifier
import com.github.naz013.feature.reminder.build.bi.ListStringModifier
import com.github.naz013.feature.reminder.build.bi.LongModifier
import com.github.naz013.feature.reminder.build.bi.NoteModifier
import com.github.naz013.feature.reminder.build.bi.OtherParams
import com.github.naz013.feature.reminder.build.bi.OtherParamsModifier
import com.github.naz013.feature.reminder.build.bi.PhoneNumberModifier
import com.github.naz013.feature.reminder.build.bi.PlaceModifier
import com.github.naz013.feature.reminder.build.bi.RecurParamModifier
import com.github.naz013.feature.reminder.build.bi.ShopItemsModifier
import com.github.naz013.feature.reminder.build.bi.StringModifier
import com.github.naz013.feature.reminder.build.bi.SummaryModifier
import com.github.naz013.feature.reminder.build.bi.TimeModifier
import com.github.naz013.feature.reminder.build.bi.TimerExclusion
import com.github.naz013.feature.reminder.build.bi.TimerExclusionModifier
import com.github.naz013.feature.reminder.build.bi.WebAddressModifier
import com.github.naz013.feature.reminder.build.bi.constraint.BiConstraint
import com.github.naz013.feature.reminder.build.bi.constraint.constraints
import com.github.naz013.feature.reminder.build.formatter.ApplicationFormatter
import com.github.naz013.feature.reminder.build.formatter.AttachmentsFormatter
import com.github.naz013.feature.reminder.build.formatter.BypassDndFormatter
import com.github.naz013.feature.reminder.build.formatter.CalendarDurationFormatter
...
import com.github.naz013.feature.reminder.build.formatter.LedColorFormatter
import com.github.naz013.ui.notification.settings.LockScreenVisibilityFormatter
import com.github.naz013.feature.reminder.build.formatter.OtherParamsFormatter
import com.github.naz013.ui.notification.settings.PriorityFormatter
import com.github.naz013.feature.reminder.build.formatter.RepeatLimitFormatter
import com.github.naz013.feature.reminder.build.formatter.TimerExclusionFormatter
import com.github.naz013.ui.notification.settings.VibrationPatternFormatter
import com.github.naz013.feature.reminder.build.formatter.WakeScreenFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.BeforeTimeFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.DateFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.DayOfMonthFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.DayOfYearFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.RepeatIntervalFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.RepeatTimeFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.TimeFormatter
import com.github.naz013.feature.reminder.build.formatter.datetime.TimerFormatter
...
internal data class GoogleCalendarDurationBuilderItem(
  ...
  override val isForPro: Boolean = false
  override val modifier: BuilderModifier<CalendarDuration> =
    GoogleCalendarDurationModifier(
...
internal sealed class ICalBuilderItem<T>(
  ...
  fun getRecurParam(): RecurParam? = modifier.getValue()?.let { createRecurParam(it) }
...
internal data class ICalWeekStartBuilderItem(
  ...
  override fun createRecurParam(value: DayValue): RecurParam = WeekStartRecurParam(value)
}
