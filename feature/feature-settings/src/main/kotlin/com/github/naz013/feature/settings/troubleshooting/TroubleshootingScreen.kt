...
import com.github.naz013.feature.settings.R as SettingsR
  ...
  Column(
    ...
    if (state.showBatteryOptimizationCard) {
      Card(
        ...
        Column(modifier = Modifier.padding(8.dp)) {
          Row {
            Icon(
              painter = AppIcons.Fluent.BatterySaver,
    ...
    if (state.showEmptyView) {
      Column(
        ...
        val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(SettingsR.raw.empty_status))
        LottieAnimation(
