...
internal class NextReminderWidgetConfigActivity : ComposeWidgetConfigActivity() {

  private val viewModel by viewModel<NextReminderWidgetConfigViewModel> { parametersOf(widgetId) }
