...
public class DeleteGroupFilesAsync extends AsyncTask<String, Void, Void> {

    private Context mContext;

    public DeleteGroupFilesAsync(Context context) {
    ...
    protected Void doInBackground(String... params) {
        for (String uid : params) {
            String exportFileName = uid + FileConfig.FILE_NAME_GROUP;
            ...
            if (isConnected) {
                ...
                if (google != null && google.getDrive() != null) {
                    try {
                        google.getDrive().deleteGroupFileByName(exportFileName);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
