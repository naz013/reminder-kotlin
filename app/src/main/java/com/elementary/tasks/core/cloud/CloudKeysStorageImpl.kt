...
class CloudKeysStorageImpl(
  ...
  override fun getGoogleDriveUserName(): String = prefs.driveUser

  override fun saveGoogleDriveUserName(name: String) {
    prefs.driveUser = name
  }

  override fun getDropboxToken(): String = prefs.dropboxToken

  override fun saveDropboxToken(token: String) {
    prefs.dropboxToken = token
  }

  override fun getGoogleTasksUserName(): String = prefs.tasksUser
