 ...
 */
class CallsAsync(private val mContext: Context, private val mListener: CallsLogListener?) : AsyncTask<Void, Void, Void>() {

    private var mList: MutableList<CallsItem>? = null
