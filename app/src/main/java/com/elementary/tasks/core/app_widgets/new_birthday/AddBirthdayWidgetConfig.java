...
public class AddBirthdayWidgetConfig extends ThemedActivity {

    private int widgetID = AppWidgetManager.INVALID_APPWIDGET_ID;
    private Intent resultValue;
    public final static String ADD_BIRTHDAY_WIDGET_PREF = "widget_pref";
    public final static String ADD_BIRTHDAY_WIDGET_COLOR = "widget_color_";
    private int color;
    ...
    private void initActionBar() {
        ...
        binding.toolbar.setTitle(getString(R.string.add_birthday));
    }
