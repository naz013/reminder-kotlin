...
class TasksWidgetConfig : ThemedActivity() {
    ...
    private var binding: WidgetTasksConfigBinding? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        readIntent()
        binding = DataBindingUtil.setContentView(this, R.layout.widget_tasks_config)
        initActionBar()
        loadThemes()
        showCurrentTheme()
    }
    ...
    private fun initActionBar() {
        ...
        binding!!.toolbar.title = getString(R.string.google_tasks)
    }
    ...
    private fun updateWidget() {
        val sp = getSharedPreferences(TASKS_WIDGET_PREF, Context.MODE_PRIVATE)
        val editor = sp.edit()
        editor.putInt(TASKS_WIDGET_THEME + widgetID, binding!!.themePager.currentItem)
        editor.apply()
    ...
    private inner class MyFragmentPagerAdapter internal constructor(fm: FragmentManager, private val arrayList: List<TasksTheme>) : FragmentPagerAdapter(fm) {
    ...
    companion object {
        val TASKS_WIDGET_PREF = "tasks_pref"
        val TASKS_WIDGET_THEME = "tasks_theme_"
    }
}
