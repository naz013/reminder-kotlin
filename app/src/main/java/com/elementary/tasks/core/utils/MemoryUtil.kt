...
object MemoryUtil {
    ...
    val DIR_SD = "backup"
    private val DIR_IMAGE_CACHE = "img"
    private val DIR_PREFS = "preferences"
    val DIR_NOTES_SD = "notes"
    val DIR_GROUP_SD = "groups"
    val DIR_BIRTHDAY_SD = "birthdays"
    val DIR_PLACES_SD = "places"
    val DIR_TEMPLATES_SD = "templates"
    private val DIR_MAIL_SD = "mail_attachments"
    private val DIR_SD_DBX_TMP = "tmp_dropbox"
    private val DIR_NOTES_SD_DBX_TMP = "tmp_dropbox_notes"
    private val DIR_GROUP_SD_DBX_TMP = "tmp_dropbox_groups"
    private val DIR_BIRTHDAY_SD_DBX_TMP = "tmp_dropbox_birthdays"
    private val DIR_PLACES_SD_DBX_TMP = "tmp_dropbox_places"
    private val DIR_TEMPLATES_SD_DBX_TMP = "tmp_dropbox_templates"
    private val DIR_PREFERENCES_SD_DBX_TMP = "tmp_dropbox_preferences"
    private val DIR_SD_GDRIVE_TMP = "tmp_gdrive"
    private val DIR_NOTES_SD_GDRIVE_TMP = "tmp_gdrive_notes"
    private val DIR_GROUP_SD_GDRIVE_TMP = "tmp_gdrive_group"
    private val DIR_BIRTHDAY_SD_GDRIVE_TMP = "tmp_gdrive_birthdays"
    private val DIR_PLACES_SD_GDRIVE_TMP = "tmp_gdrive_places"
    private val DIR_TEMPLATES_SD_GDRIVE_TMP = "tmp_gdrive_templates"
    private val DIR_PREFERENCES_SD_GDRIVE_TMP = "tmp_gdrive_preferences"
