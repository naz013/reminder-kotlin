 ...
 */
class RoboCheckBox : AppCompatCheckBox {
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            val a = context.obtainStyledAttributes(attrs, R.styleable.RoboCheckBox)
            val fontCode = a.getInt(R.styleable.RoboCheckBox_check_font_style, -1)
