...
class GoogleTaskAdsHolder(parent: ViewGroup, adsProvider: AdsProvider, failListener: () -> Unit)
    : BaseHolder<ListItemGoogleTaskAdsBinding>(parent, R.layout.list_item_google_task_ads) {
