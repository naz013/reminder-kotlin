package com.elementary.tasks.settings.reminders.help
 ...
 * [com.elementary.tasks.reminder.build.help.ReminderHelpScreen].
 */
...
fun NotificationCustomizationHelpScreen(onBackClick: () -> Unit) {
  ...
  Scaffold(
    topBar = {
      TopAppBar(
        title = {
          Text(text = stringResource(com.elementary.tasks.R.string.notification_customization))
        },
        navigationIcon = {
