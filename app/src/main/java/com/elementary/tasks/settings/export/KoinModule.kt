...
val syncSettingsModule =
  module {
    ...
    factory<BackgroundTask>(named(ObservableEraseDataTask.TASK_KEY)) { ObservableEraseDataTask(get(), get()) }

    viewModel { CloudBackupSettingsViewModel(get(), get(), get(), get(), get(), get()) }
