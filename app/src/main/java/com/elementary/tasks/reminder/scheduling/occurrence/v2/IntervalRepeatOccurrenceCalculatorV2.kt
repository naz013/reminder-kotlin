...
/**
 * `ReminderV2`-typed mirror of [com.elementary.tasks.reminder.scheduling.occurrence.IntervalRepeatOccurrenceCalculator].
 * Covers repeating [RecurrenceRule.Daily]/[RecurrenceRule.Countdown] reminders.
 */
