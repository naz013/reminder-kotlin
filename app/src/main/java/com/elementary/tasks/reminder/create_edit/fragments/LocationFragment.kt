...
class LocationFragment : RadiusTypeFragment() {
    ...
    private var binding: FragmentReminderLocationBinding? = null
    ...
    override fun prepare(): Reminder? {
        ...
        places.add(Place(radius, advancedMapFragment!!.markerStyle, lastPos!!.latitude, lastPos!!.longitude, `interface`!!.summary, number, null))
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding!!.searchField.setOnItemClickListener { parent, view1, position, id ->
            val sel = binding!!.searchField.getAddress(position)
            val lat = sel.latitude
            val lon = sel.longitude
            val pos = LatLng(lat, lon)
            var title: String? = `interface`!!.summary
    ...
    companion object {
        ...
        private val CONTACTS = 122
        val CONTACTS_ACTION = 123
    }
}
