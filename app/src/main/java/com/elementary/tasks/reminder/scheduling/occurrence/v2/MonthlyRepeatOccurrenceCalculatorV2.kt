...
/**
 * `ReminderV2`-typed mirror of [com.elementary.tasks.reminder.scheduling.occurrence.MonthlyRepeatOccurrenceCalculator].
 * Covers [RecurrenceRule.Monthly] reminders.
 */
class MonthlyRepeatOccurrenceCalculatorV2(
  ...
  override suspend fun calculateOccurrences(
    ...
    val monthly = reminder.recurrence as? RecurrenceRule.Monthly
    if (monthly == null || monthly.dayOfMonth < 0) {
  ...
  companion object {
    private const val TAG = "MonthlyRepeatOccurrCalcV2"
  }
}
