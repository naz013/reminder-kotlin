...
class DeleteFilesAsync(private val mContext: Context) : AsyncTask<String, Void, Void>() {

    override fun doInBackground(vararg params: String): Void? {
        for (uid in params) {
            val exportFileName = uid + FileConfig.FILE_NAME_REMINDER
            ...
            if (isConnected) {
                Dropbox().deleteReminder(exportFileName)
