...
public class DeleteFilesAsync extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
        for (String uid : params) {
            String exportFileName = uid + FileConfig.FILE_NAME_REMINDER;
            ...
            if (isConnected){
                ...
                if (google != null && google.getDrive() != null) {
                    try {
                        google.getDrive().deleteReminderFileByName(exportFileName);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
