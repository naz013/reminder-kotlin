...
class SyncDataConverterImplSettingsTest {
  ...
  @Test
  fun `encode and decode empty settings should work`() =
    runTest {
      // Arrange
  ...
  @Test
  fun `encode and decode settings with string values should work`() =
    runTest {
      // Arrange
      val testData =
        mapOf(
  ...
  @Test
  fun `encode and decode settings with mixed data types should work`() =
    runTest {
      // Arrange
      val testData =
        mapOf(
  ...
  @Test
  fun `encode and decode settings with special characters should work`() =
    runTest {
      // Arrange
      val testData =
        mapOf(
      ...
      // Assert
      assertEquals(
        "special_chars should match",
        "!@#$%^&*()_+-={}[]|\\:;\"'<>,.?/~`",
        decodedSettings.data["special_chars"],
      )
      assertEquals(
        "unicode should match",
        "こんにちは世界 🌍",
  ...
  @Test
  fun `encode and decode settings with null values should work`() =
    runTest {
      // Arrange
      val testData =
        mapOf<String, Any?>(
  ...
  @Test
  fun `encode and decode settings with very long values should work`() =
    runTest {
      // Arrange
  ...
  @Test
  fun `encode and decode settings with many keys should work`() =
    runTest {
  ...
  @Test
  fun `encoded data should be Base64 encoded`() =
    runTest {
      // Arrange
      ...
      assertTrue(
        "Encoded data should match Base64 pattern",
  ...
  @Test
  fun `multiple encode decode cycles should maintain data integrity`() =
    runTest {
      // Arrange
      val testData =
        mapOf(
  ...
  @Test
  fun `input stream should be readable after creation`() =
    runTest {
      // Arrange
  ...
  @Test
  fun `stream can be read multiple times by recreating`() =
    runTest {
      // Arrange
      val testData = mapOf("test" to "data")
      val originalSettings = SettingsModel(testData)
  ...
  @Test
  fun `encode and decode realistic app settings should work`() =
    runTest {
