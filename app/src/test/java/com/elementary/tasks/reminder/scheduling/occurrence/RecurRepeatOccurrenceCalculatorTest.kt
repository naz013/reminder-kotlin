...
class RecurRepeatOccurrenceCalculatorTest {
  ...
  @Test
  fun `calculateOccurrences should handle RRULE with UNTIL date`() =
    runTest {
  ...
  @Test
  fun `calculateOccurrences should return empty list for empty recurDataObject`() =
    runTest {
      // Arrange
      val reminder =
        Reminder(
  ...
  @Test
  fun `calculateOccurrences should return empty list for null recurDataObject`() =
    runTest {
      // Arrange
      val reminder =
        Reminder(
  ...
  @Test
  fun `calculateOccurrences should handle monthly RRULE`() =
    runTest {
  ...
  @Test
  fun `calculateOccurrences should handle complex RRULE pattern`() =
    runTest {
