...
class EditBirthdayViewModelTest : BaseTest() {
  ...
  @Test
  fun testCreateBirthday_activityStarted() =
    runTest {
  ...
  @Test
  fun testEditBirthday_fromObject() =
    runTest {
      val objectId = "1"
      val date = LocalDate.now()
      val formattedDate = "AAA"
  ...
  @Test
  fun testEditBirthday_fromObject_sameId() =
    runTest {
      val objectId = "1"
      val date = LocalDate.now()
      val formattedDate = "AAA"
  ...
  @Test
  fun testEditBirthday_fromUri_failedToRead() =
    runTest {
      val date = LocalDate.now()
      val formattedDate = "AAA"
      val birthdayDate = "1999-10-01"
  ...
  @Test
  fun testEditBirthday_fromUri_sameId() =
    runTest {
      val objectId = "1"
      val date = LocalDate.now()
      val formattedDate = "AAA"
