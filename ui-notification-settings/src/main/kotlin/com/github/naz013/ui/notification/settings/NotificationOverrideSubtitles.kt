 ...
 * either as the overridden value or as "Inherited: <effective settings value>". Shared by the
 * group editor and group details screens (and the reminder settings screen) so the "applied"
 * wording stays identical everywhere it's shown.
 */
